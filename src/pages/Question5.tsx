...
import { saveQuestionResult, saveComplexQuestionResult, clearQuestionResult, UserExampleAudio } from "../redux/Action";
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-200">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto bg-white/80 rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          {/* user example input */}
          {mainAnswer === "yes" && (score === null || userExample || userExampleAudio || noExamplesChecked) && (
            <div className="mb-6">
