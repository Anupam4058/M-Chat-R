...
const Question11: React.FC = () => {
  ...
  useEffect(() => {
    if (mainAnswer === "yes") {
      // Yes answer immediately results in PASS (score 0)
      setScore(0);
      ...
      // Only calculate score if BOTH sections are completely answered
      if (zeroComplete && oneComplete) {
        ...
        // Reset score if not all questions are answered
        setScore(null);
      }
    }
  ...
  const handleMainAnswer = (answer: "yes" | "no") => {
    ...
    if (answer === "yes") {
      // Yes answer immediately results in PASS
      setScore(0);
    } else {
      // No answer leads to example questions
        ...
        <div className="max-w-4xl mx-auto bg-white/80 rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-medium text-gray-600">Question 11 of 20</span>
              <span className="text-sm font-medium text-gray-600">55%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 h-2 rounded-full" style={{ width: '55%' }}></div>
            </div>
          </div>
          ...
          {mainAnswer === "no" && currentSection !== "main" && (
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-blue-800">
                What makes {childName} smile? (If parent does not give a 0 example below, ask each individually.)
              </p>
            </div>
          )}
          ...
          {currentSection === "zero" && (
            <div className="mb-6">
              <div className="text-center mb-4">
                   ...
                   Does {childName}... (Below are 0 examples)
                 </h3>
              </div>
          ...
          {score !== null && (
            <div className="mb-6 p-4 border rounded-lg">
              ...
              <p className={`text-sm ${
                ...
                {score === 0 
                  ? `${childName} shows appropriate smiling responses.` 
                  : `${childName} may need further evaluation for smiling behaviors.`
                }
              </p>
            </div>
          )}
