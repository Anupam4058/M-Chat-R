    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-200 flex flex-col items-center justify-center py-8 px-2">
      <div className="w-full max-w-5xl bg-white/80 rounded-2xl shadow-2xl p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-100 rounded-xl p-6 border border-blue-200 text-left">
            ...
            <ul className="space-y-3 text-blue-700 text-left">
              <li className="flex items-start text-left">
                <span className="text-blue-500 mr-3 text-lg">•</span>
                <span className="text-left">20 questions about your child's behavior</span>
              </li>
              <li className="flex items-start text-left">
                <span className="text-blue-500 mr-3 text-lg">•</span>
                <span className="text-left">Takes approximately 10-15 minutes to complete</span>
              </li>
              <li className="flex items-start text-left">
                <span className="text-blue-500 mr-3 text-lg">•</span>
                <span className="text-left">Answer based on your child's typical behavior</span>
              </li>
              <li className="flex items-start text-left">
                <span className="text-blue-500 mr-3 text-lg">•</span>
                <span className="text-left">You can save your progress and return later</span>
              </li>
            </ul>
          </div>
          
          <div className="bg-gradient-to-r from-amber-50 to-orange-100 rounded-xl p-6 border border-amber-200 text-left">
            ...
            <p className="text-amber-700 leading-relaxed text-left">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-100 rounded-xl p-6 border border-purple-200 text-left">
          ...
          <p className="text-purple-700 leading-relaxed text-left">
