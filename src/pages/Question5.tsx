              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-700">
                    Describe {childName}'s finger movements when {getPronoun("subject")} makes unusual movements near {getPronoun("possessive")} eyes:
                  </p>
                ...
                <div className="space-y-3">
                  <textarea
                    ...
                    placeholder="For example: Wiggling fingers close to eyes, holding hands near face, or flapping hands near eyes?"
                    className={`w-full px-3 py-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none ${score !== null ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                    rows={6}
                    disabled={score !== null}
                  />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      disabled={score !== null}
                    />
                      <label htmlFor="noExamples" className={`text-sm ${score !== null ? 'text-gray-500' : 'text-gray-700'}`}>
