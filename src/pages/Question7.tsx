...
const Question7: React.FC = () => {
  ...
  const existingResult = questionResults?.find((result: any) => result.questionId === 7);
  ...
  const [currentSection, setCurrentSection] = useState<"main" | "example" | "sub" | "followup" | "final">("main");
  ...
  useEffect(() => {
    if (existingResult?.completed && !isResetting) {
      ...
      // Structure: [subQuestions..., followUpAnswer, finalAnswer]
      ...
      const final = savedSubAnswers[subAnswersCount + 1] as "yes" | "no" | null;
      
      setSubAnswers(subAns);
      if (followUp) setFollowUpAnswer(followUp);
      if (final) setFinalAnswer(final);
  ...
  }, [mainAnswer, subAnswers, followUpAnswer, finalAnswer, subQuestions.length]);
  ...
  const handleConfirmReset = () => {
    ...
    dispatch(clearQuestionResult(7));
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-200">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto bg-white/80 rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          {mainAnswer === "yes" && (
            <div className="mb-6">
              <p className="text-gray-800 font-semibold mb-6 text-center text-lg">
                Please give me an example of something {childName} might point at to show you.
              </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-900 text-left">
                      When {childName} points at something to show you:
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-100 border border-blue-200 rounded-lg p-4 flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-900 text-left">
                      This helps us understand {childName}'s pointing behaviors for sharing interest.
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.checked) {
                        // Auto-mark as saved when user selects no examples
                        setExamplesSaved(true);
                        setUserExample("");
                        setUserExampleAudio(null);
                      } else {
          ...
          {(currentSection === "sub" || currentSection === "followup" || currentSection === "final" || score !== null) && (
            <div className="mb-6">
          ...
          {(currentSection === "followup" || currentSection === "final" || followUpAnswer !== null) && (
            <div className="mb-6">
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-gray-700">
                  Follow-up Question
          ...
          {/* Final Question Box */}
          {(currentSection === "final" || finalAnswer !== null) && (
            <div className="mb-6">
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-gray-700">
                  Final Question
